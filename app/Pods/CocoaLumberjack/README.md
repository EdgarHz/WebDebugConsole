...
CocoaLumberjack
===============
##use printf & remote log
```
pod 'CocoaAsyncSocket', '~> 7.5.0'
pod 'CocoaHTTPServer', '~> 2.3'
pod 'CocoaLumberjack', :git => 'https://github.com/EdgarHz/CocoaLumberjack.git', :branch => 'dev_printf'

#import <CocoaLumberjack/CocoaLumberjack.h>
#import <CocoaLumberjack/LogConsole.h>
static const DDLogLevel ddLogLevel = DDLogLevelVerbose;

[[LogConsole shared] setupLogger];
[[LogConsole shared] setupRemoteConsole];

PRLogVerbose(@"printf n \n");
```
